...
def fixtures() -> dict[str, tuple[bool, bytearray, str]]:
    ...
    out: dict[str, tuple[bool, bytearray, str]] = {
        ...
        "valid-duplicate-chain.vbuf": (True, canonical([
            ...
            {"key": 7, "width": 8, "count": 1, "payload": b"B", "continuation": True},
            {"key": 7, "width": 8, "count": 1, "payload": b"C"},
        ]), "three duplicate KeyIDs with valid 1-to-1-to-0 forward continuation"),
        ...
        "valid-writer-primitives.vbuf": (True, canonical([
            {"key": 10, "width": 8, "count": 3, "payload": bytes([1, 2, 255])},
            {"key": 11, "width": 16, "count": 2, "payload": struct.pack("<HH", 0x1234, 0xabcd)},
            {"key": 12, "width": 32, "count": 2, "payload": struct.pack("<II", 1, 0xdeadbeef)},
            {"key": 13, "width": 64, "count": 2, "payload": struct.pack("<QQ", 1, 0x0102030405060708)},
            {"key": 14, "semantic": 2, "width": 8, "count": 2, "payload": struct.pack("<bb", -1, 2)},
            {"key": 15, "semantic": 2, "width": 16, "count": 2, "payload": struct.pack("<hh", -2, 3)},
            {"key": 16, "semantic": 2, "width": 32, "count": 2, "payload": struct.pack("<ii", -3, 4)},
            {"key": 17, "semantic": 2, "width": 64, "count": 2, "payload": struct.pack("<qq", -4, 5)},
            {"key": 18, "semantic": 1, "width": 32, "count": 2, "payload": struct.pack("<ff", 1.5, -2.25)},
            {"key": 19, "semantic": 1, "width": 64, "count": 2, "payload": struct.pack("<dd", 3.5, -4.75)},
            {"key": 20, "semantic": 3, "width": 8, "count": 3, "payload": b"abc"},
            {"key": 21, "physical": 0, "width": 32, "count": 1, "payload": struct.pack("<I", 42)},
            {"key": 22, "semantic": 3, "width": 8, "count": 1, "payload": b"A", "continuation": True},
            {"key": 22, "semantic": 3, "width": 8, "count": 1, "payload": b"B"},
        ], base_shift=4), "canonical portable primitives, scalar, and forward continuation"),
