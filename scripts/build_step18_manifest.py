...
def metadata_plan(artifact) -> list[dict[str, object]]:
    ...
    fields = [
        ...
        ("qwen3.attention.head_count_kv", "KV head count", "KVHeadCount", "MISSING", metadata.get("qwen3.attention.head_count_kv")),
        ("qwen3.attention.key_length", "key head dimension", "KeyHeadDimension", "MISSING", metadata.get("qwen3.attention.key_length")),
        ("qwen3.attention.value_length", "value head dimension", "ValueHeadDimension", "MISSING", metadata.get("qwen3.attention.value_length")),
