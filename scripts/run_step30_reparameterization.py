...
def main():
 ...
 (out/"manifest.json").write_text(json.dumps({"step":30,"classification":"research-only; no artifact emission","tensor_count":len(tensors),"candidate_count":len(rows),"rank_set":[8,16,32],"validation_levels":["matrix reconstruction","random action preservation"],"full_model_copy_runtime":False},indent=2)+"\n")
